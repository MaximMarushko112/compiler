#include "../../include/Visitors/PrintVisitor.hpp"
...
// Types
void PrintVisitor::visit(const VoidType&) { out << "void"; }
void PrintVisitor::visit(const IntType&)   { out << "int"; }
void PrintVisitor::visit(const UnsignedType&) { out << "unsigned"; }
void PrintVisitor::visit(const FloatType&) { out << "float"; }
void PrintVisitor::visit(const BoolType&)  { out << "bool"; }
void PrintVisitor::visit(const StringType&){ out << "string"; }
void PrintVisitor::visit(const NamedType& n) { out << n.name; }

void PrintVisitor::visit(const PointerType& p) {
    p.pointee->accept(*this);
    out << '*';
}

void PrintVisitor::visit(const ArrayType& a) {
...
void PrintVisitor::visit(const FunctionType& f) {
    out << '(';
...
void PrintVisitor::visit(const TupleType& t) {
    out << '(';
...
void PrintVisitor::visit(const GotoStmt& g) {
    printIndent();
    out << "goto " << g.label << ";\n";
}

void PrintVisitor::visit(const LabelStmt& l) {
    printIndent();
    out << l.name << ":\n";
    increaseIndent();
